export default function Notification({data, error}){
    ...
    return (
        data.data.map((notification) => (
            <li key={notification.id} className={`${notification.lu ? "bg-white" : "bg-blue-50"} border-b border-b-gray-50 border-r-4 border-r-sky-600 px-4 py-2 rounded-tl-lg rounded-bl-lg `}>
                <a className="text-[1rem] font-semibold text-gray-600 hover:bg-gray-100 flex flex-col justify-center items-end">
