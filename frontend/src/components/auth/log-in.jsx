    ...
    try {
      ...
      if (response.ok) {
        ...
        localStorage.setItem(
          "utilisateur",
          JSON.stringify({ id, email: userEmail, roles, photo })
        );
      ...
      <div className="flex box-content animate-[text-appear-bottom_0.5s_ease-in] items-center justify-center gap-11 bg-white p-8 rounded-2xl shadow-lg w-[800px]">
        <div className="grow flex flex-col gap-4">
          ...
          >
            ...
            {success && (
              <p className=" label text-xs text-success">{success}</p>
            )}
              ...
              <div className="flex relative">
                ...
                {isVisible ? (
                  <img
                    ...
                    alt=""
                    className="h-[16px] absolute right-3 top-3 hover:cursor-pointer z-10"
                    onClick={() => {
                      setVisible(false);
                    }}
                  />
        ...
        <img
          ...
          alt="Homme et femme qui se saluent et une pancarte qui dit Hello entre eux"
