        ...
        <div className="container mx-auto h-screen flex justify-center items-center py-14 px-5">
            <div className="flex animate-[text-appear-bottom_0.5s_ease-in] box-content items-center justify-center gap-6 bg-white p-8 rounded-2xl shadow-lg w-[800px]">
                <div className="grow flex flex-col gap-4">
                    ...
                    <form action="submit" className="flex flex-col" onSubmit={(e)=>{
                        handleSubmit(e)
                    }} >
                        ...
                        <fieldset className="fieldset my-0 w-full ">
                            ...
                            <input type="password" name="password" className="input min-w-full text-[0.85rem] text-[#4F5D75] border-1 border-gray-200 focus:border-sky-400 focus:border-1 rounded-lg focus:outline-none duration-300" placeholder="Neovate123!" required/>
                        </fieldset>
                        <fieldset className="fieldset my-0 w-full ">
                            <legend className="fieldset-legend font-medium text-[0.85rem] text-[#4F5D75]">Confirmez le mot de passe :</legend>
                            <input type="password" name="confirmPassword" className="input min-w-full text-[0.85rem] text-[#4F5D75] border-1 border-gray-200 focus:border-sky-400 focus:border-1 rounded-lg focus:outline-none duration-300" placeholder="Neovate123!" required/>
                        </fieldset>
                        <button 
                        type="submit" 
                        disabled={loading}
